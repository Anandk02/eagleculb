...
const initWebRouter = (app) => {
    ...
    router.get('/wallet/rechargetrx', middlewareController, homeController.rechargePagetrx);
    ...
    router.get('/wallet/addBanktrx', middlewareController, homeController.addBanktrx);
    ...
    router.post('/api/webapi/check/Infotrx', middlewareController, userController.infotrx); // register
    router.post('/api/webapi/addBank', middlewareController, userController.addBank);
    router.post('/api/webapi/addBanktrx', middlewareController, userController.addBanktrx); // register
    ...
    router.post('/api/webapi/withdrawalTrx', middlewareController, userController.withdrawal4); // register
