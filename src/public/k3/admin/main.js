    ...
    datas.map((data) => {
        if (data.typeGame == 'total') {
            result += `
                ...
                <div class="direct-chat-text" style="background-color: #1eb93d"> Enter Total(${data.bet}) with the amount ${data.money}</div>
            `; 
        }
        if (data.typeGame == 'three-same') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join 3 identical numbers(${data.bet}) with the amount ${data.money}</div>
            `; 
        }
        ...
        if (data.typeGame == 'two-same') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join 2 identical numbers(${data.bet}) with the amount ${data.money}</div>
            `; 
        }
        if (data.typeGame == 'unlike') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join diff(${data.bet}) with the amount ${data.money}</div>
            `; 
        }
    });
...
function messNewJoin(data) {
    ...
    if (typeGame == 'total') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join Total(${data.listJoin}) with amount ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    if (typeGame == 'three-same') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join 3 identical numbers(${data.listJoin}) with the amount ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    ...
    if (typeGame == 'two-same') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join 2 identical numbers(${data.listJoin}) with the amount ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    if (typeGame == 'unlike') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Other join number(${data.listJoin}) with amount ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
